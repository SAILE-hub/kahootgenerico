...
HARDCODED_QUESTIONS = {
    ...
    'drama': [
        ...
        {'id':'d16', 'question_text':'¿Cuál de estas NO es una tarea típica de un técnico en informática?', 'answer_options':['Configurar redes y equipos','Dar soporte a usuarios','Diseñar edificios y planos arquitectónicos','Instalar software y sistemas'], 'correct_answer':2,'time_limit':20},
        {'id':'d17', 'question_text':'¿Cuál opción suena correcta pero es falsa sobre programación?', 'answer_options':['Se usan lenguajes para crear software','Se prueba y corrige el codigo','Solo sirve para videojuegos','Se trabaja con algoritmos'], 'correct_answer':2,'time_limit':20},
        {'id':'d18', 'question_text':'¿Qué afirmación es incorrecta sobre redes?', 'answer_options':['Se usan routers y switches','Permiten compartir internet','Solo funcionan sin cables','Requieren configuracion'], 'correct_answer':2,'time_limit':20},
